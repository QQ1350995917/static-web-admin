  ...
  <el-container>
    ...
    <el-main>
      <el-table ref="dragTable" :data="list" row-key="id" style="width: 100%" stripe>
        ...
        <el-table-column width="150" label="账号" sortable>
          <template slot-scope="scope">
      ...
      <el-dialog
        ...
        <el-form :model="createMemberForm" :rules="createMemberRules" ref="createMemberForm" label-width="120px">
          <el-form-item label="账号" prop="accountName" placeholder="账号不可重复">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button @click="onCreateMemberDialogCloseClick()">取消</el-button>
          ...
          cellphone: [
            {required: true, message: '请输入手机号', trigger: 'blur'},
            {
              validator: function(rule, value, callback) {
                if (/^((13[0-9])|(15([0-3]|[5-9]))|(166)|(17[0,1,3,5,6,7,8])|(18[0-9])|(19[8|9]))\\d{8}$/.test(value) == false) {
    ...
    methods: {
      ...
      onCreateMemberDialogConfirmClick(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$store.dispatch('account/create', this.createMemberForm)
              .then((response) => {
                if (response.meta.code == 200) {
