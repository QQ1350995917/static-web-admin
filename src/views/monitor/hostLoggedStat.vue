    ...
    <el-main>
      <template>
        <el-table :data="list" stripe height="750" style="width: 100%">
          ...
          <el-table-column prop="jcpu" label="jcpu"></el-table-column>
          <el-table-column prop="pcpu" label="pcpu"></el-table-column>
          <el-table-column prop="what" label="what"></el-table-column>
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      this.doRequestHostLoggedStat(this.pageIndex, this.pageSize)
    },
    methods: {
      ...
      doRequestHostLoggedStat(pageIndex, pageSize){
        requestHostLoggedStatApi([],pageIndex - 1, pageSize).then((res) => {
          this.list = []
